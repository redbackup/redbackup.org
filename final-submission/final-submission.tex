...
Today, most individuals and small to medium enterprises have limited choice in regards to data backup storage. One possibility is the utilisation of local storage media, as e.g. hard disk drives, which lead to missing physical data redundancy and requires personal effort. A second possibility is a public cloud environment, which leads to privacy issues and a high dependency on third party storage providers. No easy to use, distributed backup systems with private data storage is available.
\vspace*{1em}
...
Finally, we present a prototype of the proposed client and node applications with a reduced feature set, developed in the Rust programming language.
\end{abstract}
