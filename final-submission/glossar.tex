...
\newglossaryentry{system-m-replication}
{
    ...
    description={\Glspl{node} replicate chunks to all other nodes, leading to an equal number of \glspl{node} and redundancy degreee in the system. See \fullref{sec:fundamental-design-decisions}.}
}