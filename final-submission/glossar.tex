...
{
    name={node},
    description={An core participant in the system that manages \gls{Chunks} (See \fullref{sec:component-node})}
}
...
{
    name={client},
    description={An piece of software that runs on a users computer that is in charge of creating and restoring backups (See \fullref{sec:component-client})}
}

\newglossaryentry{management}
{
    name={management},
    description={An Component that orchestrates the configuration of the system (See \fullref{sec:component-management})}
}
