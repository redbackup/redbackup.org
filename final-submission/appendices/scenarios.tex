...
\begin{scenario}{node-join}{Node joining}
    ...
    \begin{enumerate}
    	...
    	\item The new node configures itself based on its \emph{node identifier} and the response from the management.
    		...
    		\end{itemize}
    	\item
    	Other nodes learn about the new node through periodical metadata queries (message: \emph{node fetch all nodes metadata}) %TODO: Component description: regular queries
    		\begin{enumerate}
...
\begin{scenario}{management-problems}{Management problems}
