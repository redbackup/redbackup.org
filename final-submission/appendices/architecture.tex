...
\section{Architectural Concept Paper}\label{sec:specification}
...
An \gls{administrator} wants to interact with the \gls{system} as seldom as possible. He/She wants to be sure that the \gls{system} runs smoothly. If something goes wrong, he/she wants to be able to fix it within a few minutes.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Deserialise \glspl{chunk-index}
...
\begin{figure}[h]
    ...
    \caption{Node Leaving Unplanned UML Sequence Diagram}
...
\begin{itemize}
    \item If the \gls{node} returns, it carries on as if nothing had happened.
...
The still available \glspl{node} should try to fulfil redundancy needs as good as possible.
