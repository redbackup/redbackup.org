...
\begin{table}[h!]
    \begin{tabu}{| >{\ttfamily}l | X |}
        ...
        \hline
        type
        & A string representation of the \gls{message-type}, as described in subsections \fullref{sec:messages}. \\
        \hline
    \end{tabu}
...
\begin{table}[h!]
    \begin{tabu}{| >{\ttfamily}l | X |}
        ...
        \hline
        type
        & A string representation of the payload type, as described in subsections \fullref{sec:messages}. \\
        \hline
    \end{tabu}
