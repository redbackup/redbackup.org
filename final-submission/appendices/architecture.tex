...
\begin{itemize}
    ...
    \item The relationship between a given \emph{File} and its \emph{Chunk}s is essential. The \emph{Client} splits a \emph{File} into multiple \emph{Chunks} to speed up the backup of large data. During the study project, a \emph{File} consists of exactly one \emph{Chunk}.
