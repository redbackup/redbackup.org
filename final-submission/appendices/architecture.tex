...
With a \emph{get designation}, a \gls{client} requests the permit to create backup onto an \gls{node}.

The information sent with this request permit the \gls{node} to decide, whether or not it wants to receive a possible backup.
...
With a \emph{get chunk states}, a \gls{client} requests the current availability of \glspl{chunk} on a \gls{node}.
